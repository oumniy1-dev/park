...
import 'cancel_successful_screen.dart';

class CancelParkingScreen extends StatefulWidget {
  final BookedSpot spot;
  const CancelParkingScreen({super.key, required this.spot});
  @override
  State<CancelParkingScreen> createState() => _CancelParkingScreenState();
}

class _CancelParkingScreenState extends State<CancelParkingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double paid =
        double.tryParse(widget.spot.price.replaceAll('\$', '').trim()) ?? 0.0;
    double refund = paid * 0.8;
    String paidStr = '\$${paid.toStringAsFixed(2)}';
    String refundStr = '\$${refund.toStringAsFixed(2)}';
    return Scaffold(
